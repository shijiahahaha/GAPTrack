...
class Tracker:
    ...
    def __init__(self, name: str, parameter_name: str, dataset_name: str, run_id: int = None, display_name: str = None,
                 result_only=False, checkpoint_path=None, debug=False, save_features=False, feature_dir='./backbone_features'):
        # runid改成要测试的epoch
    ...
    def create_tracker(self, params):
        ...
        # 传递特征保存相关参数
        tracker.save_features = self.save_features
        tracker.feature_dir = self.feature_dir
        tracker.feature_save_path = None
        return tracker
    ...
    def _track_sequence(self, tracker, seq, init_info):
        ...
        # 创建特征保存目录（如果需要）
        if tracker.save_features:
            tracker.feature_save_path = os.path.join(tracker.feature_dir, seq.name)
            os.makedirs(tracker.feature_save_path, exist_ok=True)
