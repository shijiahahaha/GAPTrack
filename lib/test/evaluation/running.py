...
def run_sequence(seq: Sequence, tracker: Tracker, debug=False, num_gpu=8):
    ...
    # Print detailed timing statistics if available
    if hasattr(tracker, 'tracker') and hasattr(tracker.tracker, 'print_timing_stats'):
        tracker.tracker.print_timing_stats()
